"""Original source:
https://github.com/huggingface/diffusers/blob/5156acc47688dc9facd07e0d15bff63a6b10bfdb/src/diffusers/pipelines/stable_diffusion/pipeline_stable_diffusion_img2img.py

nsfw checker is disabled:
- because it causes out of memory error on 8gb graphics cards
